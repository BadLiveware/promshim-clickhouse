...
- `20260428-high-pressure-binary-rate-measurement-gate` — **keep (measurement gate)**. Measured high-pressure binary rate comparison shapes and confirmed native serving remains dramatically superior to local (orders-of-magnitude fewer round-trips and much lower wall time). This rules out local-serving expansion experiments for this family in current conditions. Artifacts: `harness/artifacts/bench/standalone/20260428-iter78-high-pressure-rate-binary/`. Attempt notes: `.pi/loops/native-sql-optimization-sweep/attempts/20260428-high-pressure-binary-rate-measurement-gate.md`.
- `20260428-range-rate-pivot-family-measurement` — **keep (measurement gate)**. Measured a pivot candidate family (7d range-rate aggregation shapes) with focused corpus and found tight native_sql clustering (CH RT=1, similar latency/memory across modes), indicating limited immediate headroom in this setup and motivating another pivot to higher-variance/high-pressure targets. Artifacts: `harness/artifacts/bench/standalone/20260428-iter77-range-rate-hotspots-7d/`. Attempt notes: `.pi/loops/native-sql-optimization-sweep/attempts/20260428-range-rate-pivot-family-measurement.md`.
