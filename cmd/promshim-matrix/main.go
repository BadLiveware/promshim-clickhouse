...
func main() {
	jsonOut := flag.String("json-out", filepath.FromSlash("harness/artifacts/matrices/path2-compliance-matrix.json"), "JSON output path")
	mdOut := flag.String("md-out", filepath.FromSlash("harness/artifacts/matrices/path2-compliance-matrix.md"), "Markdown output path")
	flag.Parse()
