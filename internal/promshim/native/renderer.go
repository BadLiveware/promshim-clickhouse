...
// alignSubqueryStepStart returns the first step-grid timestamp strictly after
// windowStartMS, anchored to epoch 0. Mirrors Prometheus's subquery evaluator
// at prometheus/promql/engine.go:2394-2399 so native SQL pushdown of subqueries
// picks the same per-step evaluation instants as Prom's engine.
