...
func main() {
	...
	jsonOut := flag.String("json-out", filepath.FromSlash("harness/artifacts/matrices/native-promql-compliance-alignment.json"), "JSON output path")
	mdOut := flag.String("md-out", filepath.FromSlash("harness/artifacts/matrices/native-promql-compliance-alignment.md"), "Markdown output path")
